export const defaultLatexTemplate = `\\documentclass{article}
...
export const templates = {
  modern: defaultLatexTemplate,
  ats: defaultLatexTemplate.replace('\\usepackage{enumitem}', '\\usepackage[shortlabels]{enumitem}'),
  creative: defaultLatexTemplate,
  academic: defaultLatexTemplate
};
